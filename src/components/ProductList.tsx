      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 space-y-4">
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold text-neutral-950 tracking-tight leading-tight font-display">
            High-Impact <span className="text-emerald-600">Advertising</span> Products
          </h2>
          <p className="text-neutral-600 text-xs md:text-sm max-w-xl mx-auto leading-relaxed tracking-wide">
            Explore our extensive list of digital prints, custom corporate gifts, branded stationeries, uniforms, and exhibition roll-ups.
          </p>
        </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-3">
              <div className="space-y-1">
                ...
                <p className="text-xs text-neutral-500 font-mono uppercase tracking-wider">
                  Showing {filteredProducts.length} premium products based on your criteria
                </p>
              </div>
            </div>
            ...
            {filteredProducts.length > 0 ? (
              ...
              <div className="bg-white border border-neutral-200/60 rounded-3xl p-12 text-center space-y-6 shadow-sm">
                ...
                <div className="flex justify-center gap-3.5 flex-wrap pt-2">
                  ...
                  <a
                    href={`https://wa.me/971561700824?text=Hi%20Al%20Nuqta%2C%20I%20am%20looking%20for%20a%20custom%20advertising/printing%20solution%20similar%20to%20"${encodeURIComponent(searchQuery)}"%20but%20couldn't%20find%20it%20on%20the%20website.%20Can%20you%20help?`}
                    target="_blank"
                    rel="noreferrer"
                    className="py-3 px-6 bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold rounded-xl transition-all duration-200 hover:-translate-y-0.5 flex items-center gap-2 font-sans tracking-wider uppercase shadow-md shadow-emerald-950/10"
                  >
